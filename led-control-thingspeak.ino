...
unsigned long channel_num=1617308;
const char* ssid="";
const char* password="";
int led;
unsigned int value;
...
String SendHTML(void){
 ...
 ptr +="<a class=\"button button-on\" href=\"https://api.thingspeak.com/update?api_key=OSOXXSDFZF5U6PO6&field1=1\">ON</a>\n";
 ptr +="<a class=\"button button-off\" href=\"https://api.thingspeak.com/update?api_key=OSOXXSDFZF5U6PO6&field1=0\">OFF</a>\n";
 ptr +="</body>\n";
 ptr +="</html>\n";
 return ptr;
}
